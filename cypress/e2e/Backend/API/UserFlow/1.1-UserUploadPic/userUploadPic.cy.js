describe('User can upload picture through API', () => {
    it('Checking the user can upload file through API', () => {
      const picPath = "C:\\Users\\TS4U\\OneDrive\\Pictures\\Saved Pictures\\New folder\\WhatsApp Image 2023-12-09 at 12.28.56_ade94380.jpg";
      ...
      cy.fixture(picPath, 'binary').then((fileContent) => {
        ...
        cy.request({
          method: 'POST',
          url: 'https://staging-api.biyekorun.us/api/user/uploadimage',
          body: fileContent,
          headers: {
